...
const privacyPolicy = (props: Props) => {
  ...
  <p>
    ...
    purchase from  (The Roanoke Fashion Week).
  </p>
            </div>
...
<div className='flex flex-col gap-4'>
  ...
  <p>
    ...
    you browse the Site, we collect information about the individual web pages or products that you view, what websites or 
...
<div className='flex flex-col gap-4'>
  <p><b>We collect Device Information using the following technologies:</b></p>
      ...
      <ul className='flex flex-col gap-2'>
        ...
        <li>- <b>“Web beacons,” “tags,” and “pixels”</b> are electronic files used to record information about how you browse the Site.</li>
      </ul>
...
<div className='flex flex-col gap-4'>
  <h2 className='font-bold'>HOW DO WE USE YOUR PERSONAL INFORMATION?</h2>
  <p>
...
<div className='flex flex-col gap-4'>
  ...
  <p className='h-full overflow-hidden'>
    ...
    how our customers use the Site--you can read more about how Google uses your Personal Information here:  
...
<div className='flex flex-col gap-4'>
  <h2 className='font-bold'>BEHAVIOURAL ADVERTISING</h2>
  <p>
...
<div className='flex flex-col gap-4'>
  ...
  <p>
    When you place an order through the Site, we will maintain your Order Information for our records unless and until you 
...
<div className='flex flex-col gap-4'>
  ...
  <p>
    ...
    please contact us by e-mail at <b>erica@theroanokefashionweek.com</b> or by mail using the details provided below:
  </p>
  
  <p><b>4300, Roanoke, VA, 24018, United States</b></p>
</div>
            </div>
